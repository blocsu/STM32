...
void DAC_ini(void) 
{
	...
	DAC_InitTypeDef DAC_InitStruct; //структура инициализирующа€ DAC
	
	RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOA, ENABLE); //¬к. тактировани€ вывода по которому будет передавать данные DAC 
